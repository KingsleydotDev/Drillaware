...
bool ImGui::Tab(const char* label, ImTextureID icon, bool active)
{
    ...
    it_anim->second.bg2 = ImLerp(it_anim->second.bg2, active ? ImColor(205, 92, 92) : hovered ? ImColor(22, 22, 22, 150) : ImColor(0, 0, 0, 0), g.IO.DeltaTime * 6.f);
...
bool ImGui::Checkbox(const char* label, bool* v)
{
    ...
    it_anim->second.framecol = ImLerp(it_anim->second.framecol, *v ? ImColor(205, 92, 92) : hovered ? ImColor(30,30,30) : ImColor(25,25,25), g.IO.DeltaTime * 4.f);
...
{
    //ImGuiComboFlags flags = 0; // Default value
...
bool ImGui::SliderScalar(const char* label, ImGuiDataType data_type, void* p_data, const void* p_min, const void* p_max, const char* format, ImGuiSliderFlags flags)
{
    ...
    if (grab_bb.Max.x > grab_bb.Min.x) {
        ...
        window->DrawList->AddRectFilled(frame_bb.Min + ImVec2(0, 8), frame_bb.Min + ImVec2(it_anim->second.slow - 7, 16.5f), ImColor(205, 92, 92), 100, ImDrawFlags_RoundCornersLeft);
...
bool ImGui::Selectable(const char* label, bool selected, ImGuiSelectableFlags flags, const ImVec2& size_arg)
{
    ...
    it_anim->second.text_color = ImLerp(it_anim->second.text_color, selected ? ImColor(205, 92, 92) : hovered ? ImColor(71, 71, 73, 255) : ImColor(51, 51, 53, 255), g.IO.DeltaTime * 6.f);
    it_anim->second.mark_color = ImLerp(it_anim->second.mark_color, selected ? ImColor(205, 92, 92) : ImColor(0, 0, 0, 0), g.IO.DeltaTime * 6.f);
